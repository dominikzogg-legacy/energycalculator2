...
final class ComestibleCollectionMapping implements DenormalizationObjectMappingInterface
{
    /**
     * @return string
     */
    ...
    {
        return ComestibleCollection::class;
    }
    ...
    public function getDenormalizationFactory(
        ...
        return function () {
            return new ComestibleCollection();
        };
    }
